...
SOURCE_ROOTS = ("MuesliApp/ArchiveCLI", "MuesliApp/MuesliApp", "MuesliApp/MuesliAppTests", BACKEND + "/src", "scripts", "release/inference-service")
    ...
    try:
        ...
        for relative in SOURCE_ROOTS:
            for path in (root / relative).rglob("*"):
                if (relative in {BACKEND + "/src", "scripts", "release/inference-service"} and path.parent.name == "__pycache__" and path.suffix == ".pyc") or path.name == ".DS_Store":
                    continue
