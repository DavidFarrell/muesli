...
expected_ids = {service + '/Contents/MacOS/InferenceService': 'paidiaconsulting.MuesliApp.InferenceService',
                'Contents/MacOS/InferenceProof': 'paidiaconsulting.MuesliApp.InferenceProof',
...
for path in sorted(app.rglob('*')):
    ...
    expected = (expected_service if relative == service + '/Contents/MacOS/InferenceService' else
                ...
                expected_host if relative == 'Contents/MacOS/InferenceProof' else {})
...
build_record = app / 'Contents/Resources/proof-build-inputs.json'
