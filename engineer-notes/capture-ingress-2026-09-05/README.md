...
- All 126 Swift tests passed with Xcode's local test service, including 10 new capture/converter tests. Final full-suite log: `/private/tmp/muesli-ingress-tests-verified.log`.
